		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo ayarcek['ayar_author'] ?> <a href="https://www.instagram.com/kadir.haslar/">Kıymetlimiz</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_twitter'];?>" class="fflickr">Youtube</a>
